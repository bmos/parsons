...
class Community:
    ...
    def __init__(self, community_client_id=None, community_access_token=None, community_url=None):
        self.community_client_id = str(check_env.check("community_client_id", community_client_id))
        self.community_access_token = str(
        ...
        auth = BearerAuth(self.community_access_token)
