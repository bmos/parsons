...
class SolidarityTechUserNotes(SolidarityTechBase):
    ...
    def create_user_note(
        ...
        *,
        ...
        agent_id is not None and params.update({"agent_id": agent_id})
        created_at is not None and params.update({"created_at": created_at})
        interaction_method is not None and params.update({"interaction_method": interaction_method})
