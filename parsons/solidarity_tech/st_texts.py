...
class SolidarityTechTexts(SolidarityTechBase):
    ...
    def get_texts(
        ...
        expected_responses = {HTTPStatus.OK: (True, "texts listed")}
    ...
    def send_text(
        ...
        *,
        ...
        media_urls is not None and params.update({"media_urls": media_urls})
        attach_contact_card is not None and params.update(
            {"attach_contact_card": attach_contact_card}
        )
        shorten_urls is not None and params.update({"shorten_urls": shorten_urls})
        ...
        expected_responses = {HTTPStatus.CREATED: (True, "text sent")}
