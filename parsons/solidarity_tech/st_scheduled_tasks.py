...
class SolidarityTechScheduledTasks(SolidarityTechBase):
    ...
    def create_scheduled_task(
        ...
        *,
        ...
        remind_at is not None and payload.update({"remind_at": remind_at})
        ...
        notes is not None and payload.update({"notes": notes})
        marked_as_completed is not None and payload.update(
    ...
    def update_scheduled_task(
        ...
        *,
        ...
        due_at is not None and payload.update({"due_at": due_at})
        remind_at is not None and payload.update({"remind_at": remind_at})
        agent_user_id is not None and payload.update({"agent_user_id": agent_user_id})
        user_id is not None and payload.update({"user_id": user_id})
        notes is not None and payload.update({"notes": notes})
