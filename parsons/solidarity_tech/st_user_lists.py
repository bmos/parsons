...
class SolidarityTechUserLists(SolidarityTechBase):
    ...
    def get_user_lists(
        ...
        expected_responses = {HTTPStatus.OK: (True, "user lists listed")}
    ...
    def get_user_list(
        ...
        expected_responses = {
            HTTPStatus.OK: (True, "user list found"),
            HTTPStatus.NOT_FOUND: (False, "user list not found"),
        }
        self._handle_status_codes(res=res, codes=expected_responses)
    ...
    def create_user_list(
        ...
        parameters is not None and payload.update({"parameters": parameters})
        ...
        expected_responses = {
            HTTPStatus.CREATED: (True, "user list created"),
    ...
    def update_user_list(
        ...
        expected_responses = {
            HTTPStatus.OK: (True, "user list updated"),
            HTTPStatus.NOT_FOUND: (False, "user list not found"),
        }
        return self._handle_status_codes(res=res, codes=expected_responses)
    ...
    def delete_user_list(
        ...
        expected_responses = {
            HTTPStatus.OK: (True, "user list deleted"),
            HTTPStatus.NOT_FOUND: (False, "user list not found"),
        }
        return self._handle_status_codes(res=res, codes=expected_responses)
