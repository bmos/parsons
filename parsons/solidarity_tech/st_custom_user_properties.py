...
class SolidarityTechCustomUserProperties(SolidarityTechBase):
    ...
    def get_custom_user_properties(
        ...
        return Table(data, name="Solidarity Tech Custom User Properties"), meta
    ...
    def create_custom_user_property(
        ...
        """
        payload: dict[str, _JsonType] = {"label": label, "field_type": field_type}
        description is not None and payload.update({"description": description})
        options is not None and payload.update({"options": options})
        ...
        expected_responses = {
            HTTPStatus.CREATED: (True, "created"),
            HTTPStatus.UNPROCESSABLE_ENTITY: (False, "validation failed"),
        }
        self._handle_status_codes(res=res, codes=expected_responses)
    ...
    def delete_custom_user_property_option(
        ...
        expected_responses = {
            HTTPStatus.OK: (True, "option removed"),
            HTTPStatus.NOT_FOUND: (False, "option or custom user property not found"),
            HTTPStatus.UNPROCESSABLE_ENTITY: (False, "validation failed"),
        }
        self._handle_status_codes(res=res, codes=expected_responses)
    ...
    def create_custom_user_property_option(
        ...
        """
        payload: dict[str, _JsonType] = {"label": label}
        value is not None and payload.update({"value": value})
        ...
        expected_responses = {
            HTTPStatus.CREATED: (True, "option created"),
            HTTPStatus.NOT_FOUND: (False, "custom user property not found"),
            HTTPStatus.UNPROCESSABLE_ENTITY: (False, "validation failed"),
        }
        self._handle_status_codes(res=res, codes=expected_responses)
