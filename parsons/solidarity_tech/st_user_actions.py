...
class SolidarityTechUserActions(SolidarityTechBase):
    ...
    def get_user_actions(
        ...
        page_id is not None and params.update({"page_id": page_id})
        group_by is not None and params.update({"group_by": group_by})
    ...
    def create_user_action(
        ...
        created_at is not None and payload.update({"created_at": created_at})
        data is not None and payload.update({"data": data})
