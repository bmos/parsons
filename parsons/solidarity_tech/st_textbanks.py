"""Methods for interacting with the SolidarityTech Textbanks endpoint."""
...
class SolidarityTechTextbanks(SolidarityTechBase):
    ...
    def get_textbanks(
        ...
        *,
        ...
        ids is not None and params.update({"ids": ids})
        ...
        expected_responses = {HTTPStatus.OK: (True, "textbanks listed")}
    ...
    def get_textbank(
        ...
        expected_responses = {
            HTTPStatus.OK: (True, "textbank found"),
            HTTPStatus.NOT_FOUND: (False, "textbank not found"),
        }
        self._handle_status_codes(res=res, codes=expected_responses)
