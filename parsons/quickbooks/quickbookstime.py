...
class QuickBooksTime:
    ...
    def qb_get_request(self, end_point: str, querystring=None):
        ...
        while more:
            ...
            if page % 10 == 0:
                log_msg = f"Retrieved {len(output_list)} records from {end_point} endpoint."
                logger.info(log_msg)
                log_msg = f"Currently on page {page}."
                logger.info(log_msg)
    ...
    def get_groups(
        ...
        log_msg = f"Found {tbl.num_rows} groups."
        logger.info(log_msg)
        if tbl.num_rows > 0:
            return tbl
        return Table()
    ...
    def get_jobcodes(
        ...
        log_msg = f"Found {tbl.num_rows} jobs."
        logger.info(log_msg)
        if tbl.num_rows > 0:
            return tbl
        return Table()
    ...
    def get_timesheets(
        ...
        log_msg = f"Found {tbl.num_rows} timesheets."
        logger.info(log_msg)
        if tbl.num_rows > 0:
            return tbl
        return Table()
    ...
    def get_users(
        ...
        log_msg = f"Found {tbl.num_rows} users."
        logger.info(log_msg)
        if tbl.num_rows > 0:
            return tbl
        return Table()
    ...
    def get_schedule_calendars_list(
        ...
        log_msg = f"Found {tbl.num_rows} schedule calendars."
        logger.info(log_msg)
    ...
    def get_schedule_events(
        ...
        log_msg = f"Found {tbl.num_rows} schedules."
        logger.info(log_msg)
        if tbl.num_rows > 0:
            return tbl
        return Table()
    ...
    def get_geolocations(
        ...
        log_msg = f"Found {tbl.num_rows} geolocations."
        logger.info(log_msg)
