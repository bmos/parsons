...
class Redshift(
    ...
    Args:
        ...
        s3_temp_bucket: str
            ...
            Required if you intend to perform bulk data transfers
            (eg. the :meth:`~parsons.databases.redshift.redshift.Redshift.copy_s3` method),
    ...
    def generate_manifest(
        ...
        generated, you can pass it with the :meth:`~parsons.databases.redshift.redshift.Redshift.copy_s3` method.
        ...
        **copy_args,
        ...
        Args:
            ...
            from_s3: bool
                ...
                set this to True and include :meth:`~parsons.databases.redshift.redshift.Redshift.copy_s3` arguments
